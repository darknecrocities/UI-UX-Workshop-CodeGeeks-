...
export const SLIDES_DATA: SlideMeta[] = [
  ...
  { id: 13, slug: 'motion', title: 'MOTION IS NOT DECORATION', section: 'FUNDAMENTALS', tagline: 'Motion Should Explain' },
  { id: 14, slug: 'tactile', title: 'TACTILE INTERACTION', section: 'FUNDAMENTALS', tagline: 'Make Software Feel Physical' },
  { id: 15, slug: 'xy-experiment', title: 'THE X/Y EXPERIMENT', section: 'FUNDAMENTALS', tagline: 'Every Interaction Has a Position' },
  { id: 16, slug: 'prompt-skills', title: 'PROMPT DESIGN SKILLS', section: 'AI ENGINEERING', tagline: 'Prompting as an Architectural Skill' },
  { id: 17, slug: 'good-prompt', title: 'ANATOMY OF A PROMPT', section: 'AI ENGINEERING', tagline: 'From Generic to Precise' },
  { id: 18, slug: 'decisions', title: 'PROMPT FOR DECISIONS', section: 'AI ENGINEERING', tagline: 'Constraints > Components' },
  { id: 19, slug: 'activity-01', title: 'ACTIVITY 01', section: 'ACTIVITY 01', tagline: 'Sketch → Figma (60 Min)' },
  { id: 20, slug: 'break', title: 'TAKE A BREAK', section: 'BREAK', tagline: '15 Minutes Offline' },
  { id: 21, slug: 'pipeline', title: 'AI-ASSISTED DEV', section: 'AI ENGINEERING', tagline: 'Now Let the Machines Code' },
  { id: 22, slug: 'activity-02', title: 'ACTIVITY 02', section: 'ACTIVITY 02', tagline: 'Prompt → Working Product' },
  { id: 23, slug: 'slop-audit', title: 'THE SLOP AUDIT', section: 'WRAP-UP', tagline: 'Break Your Own Product' },
  { id: 24, slug: 'showcase', title: 'SHOWCASE', section: 'WRAP-UP', tagline: 'From Sketch to Ship' },
  { id: 25, slug: 'final', title: 'FINAL', section: 'WRAP-UP', tagline: "Don't Just Generate. Design." },
];
