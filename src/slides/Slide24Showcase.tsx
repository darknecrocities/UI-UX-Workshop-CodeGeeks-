  ...
  const stages = [
    {
      ...
      whyChange: 'User cognitive load during panic was too high.',
    ...
    },
    {
      ...
      whatChanged: 'Established strict 8px spatial grid and 2 font weights.',
    ...
    {
      name: 'PROMPT',
      desc: 'Architectural constraint brief',
      ...
      humanDecision: 'Enforced zero external CDNs and Web Audio procedural SFX.',
    },
    {
      name: 'CODE',
    ...
    },
    {
      ...
      whyChange: 'Transformed a static webpage into an interactive instrument.',
      aiError: 'AI does not have fingers or ears; it cannot feel physical rhythm.',
      humanDecision: 'Fine-tuned the spring physics and decibel dampening.',
    },
  ];
